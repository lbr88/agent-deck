...
| **Codex** | Status detection, MCP, organization, conductor, import, fork |
...
agent-deck hub sessions create desktop --title "remote task" --tool codex --cwd /repo --group default
agent-deck hub sessions attach desktop "remote task"
agent-deck hub sessions send desktop "remote task" "continue"
agent-deck hub sessions close desktop "remote task"
agent-deck hub sessions rename desktop "remote task" "remote task v2"
