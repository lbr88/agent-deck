...
| CAP-TUI-026 | TUI | Import sessions (i) and manual reload (ctrl+r) | verified | 2026-06-11 | evidence/tui/ev-CAP-TUI-026-TUI-import.txt, ev-CAP-TUI-026-TUI-reload.txt | i discovered an orphan tmux session (orphan_import_test) not in the registry, appended it as an instance AND added to th |
