...
func (noopMutator) UpdateSessionPaths(string, []string) error {
	return nil
}
...
func (noopMutator) UpdateSessionNotes(string, string) error {
	return nil
}
func (noopMutator) MarkSessionUnread(string) error {
	return nil
}
