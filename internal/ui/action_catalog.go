...
func actionDefinitions() []ActionDefinition {
	return []ActionDefinition{
		...
		hotkeyAction(hotkeyRestart, "Restart session", ActionCategorySelected),
		...
		hotkeyAction(hotkeyArchiveSession, "Archive session", ActionCategorySelected),
		hotkeyAction(hotkeyUnarchiveSession, "Unarchive session", ActionCategorySelected),
		...
		hotkeyAction(hotkeyCopyPane, "Copy visible terminal text, including links", ActionCategorySelected),
		...
		hotkeyAction(hotkeyHubAdmin, "Hub management (trust; admin: nodes/invites)", ActionCategoryManage),
		...
		hotkeyAction(hotkeyViewArchived, "Toggle archived view", ActionCategoryView),
