...
var (
	builtinToolNames  = []string{"Claude", "Gemini", "OpenCode", "Codex", "Kiro", "Pi", "OMP", "Copilot", "Crush", "Cursor", "Hermes"}
	builtinToolValues = []string{"claude", "gemini", "opencode", "codex", "kiro", "pi", "omp", "copilot", "crush", "cursor", "hermes"}
)
