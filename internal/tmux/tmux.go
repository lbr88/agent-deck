...
var toolDetectionOrder = []string{"kiro", "claude", "gemini", "opencode", "omp", "codex", "copilot", "crush", "cursor", "hermes", "deepseek", "pi"}
...
func (s *Session) Exists() bool {
	...
	if !exists && socketHasProtocolMismatch(s.SocketName) {
		return true
	}
	return exists
}
